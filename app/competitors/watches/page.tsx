    ...
    <div className="min-h-screen bg-zinc-50">
      ...
      <main id="main-content" className="mx-auto max-w-3xl px-4 py-8">
        ...
        <p className="mt-2 text-sm text-zinc-600">
          Track named rivals with repeat scans. For topic-first Meta Ad Library pulls and saved summaries, use{" "}
          <Link href="/competitors/harvest" className="font-medium text-violet-700 hover:underline">
