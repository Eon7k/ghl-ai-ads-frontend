        ...
        <li>
          ...
          <ul className="mt-1.5 list-disc space-y-1 pl-4 text-zinc-600">
            ...
            <li>
              ...
              <code className="rounded bg-zinc-100 px-0.5">APP_ID|APP_SECRET</code> (app access token) for Ad Library. Or set a
              single long-lived token in <code className="rounded bg-zinc-100 px-1">META_AD_LIBRARY_TOKEN</code> instead.
            </li>
            <li>
